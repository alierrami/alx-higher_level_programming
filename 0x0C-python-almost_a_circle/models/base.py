...
class Base:
    ...
    def from_json_string(json_string):
        """Return the deserialization of json
        Args:
    ...
    def load_from_file(cls):
        ...
        """
        the_file = str(cls.__name__) + ".json"
        try:
            with open(the_file, "r") as jsonfile:
    ...
    def save_to_file_csv(cls, list_objs):
        ...
        Args:
            list_objs (list): A list of inherited Base instances.
        """
        the_file = cls.__name__ + ".csv"
        with open(the_file, "w", newline="") as csvfile:
